...
class Block(nn.Module):
    def __init__(self, in_channels, out_channels, group=1, split = 0.25):
        ...
        self.r0 = ops.BasicBlock_dw(in_channels, in_channels)
        self.r1 = ops.BasicBlock_dw(self.remaining_channels, in_channels)
        self.r2 = ops.BasicBlock_dw(self.remaining_channels, in_channels)
